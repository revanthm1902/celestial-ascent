...
const instructors = [
  {
    ...
    avatar: <svg viewBox="0 0 24 24" fill="none" className="w-full h-full"><defs><linearGradient id="volt-grad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#3b82f6"/><stop offset="50%" stopColor="#06b6d4"/><stop offset="100%" stopColor="#0ea5e9"/></linearGradient></defs><path d="M13 2L3 14h8l-1 8 10-12h-8l1-8z" fill="url(#volt-grad)" stroke="url(#volt-grad)" strokeWidth="1"/></svg>,
  ...
  },
  {
    ...
    avatar: <svg viewBox="0 0 24 24" fill="none" className="w-full h-full"><defs><radialGradient id="gravity-grad"><stop offset="0%" stopColor="#06b6d4"/><stop offset="50%" stopColor="#0891b2"/><stop offset="100%" stopColor="#0e7490"/></radialGradient></defs><circle cx="12" cy="12" r="10" fill="url(#gravity-grad)" opacity="0.3"/><circle cx="8" cy="8" r="2" fill="#06b6d4"/><circle cx="16" cy="10" r="1.5" fill="#0e7490"/><circle cx="10" cy="16" r="1" fill="#0891b2"/><circle cx="17" cy="16" r="2" fill="#06b6d4"/><circle cx="12" cy="12" r="1.5" fill="#0ea5e9"/></svg>,
